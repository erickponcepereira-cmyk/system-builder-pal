...
import {
  ...
  Image, IdCard, BookOpen, Undo2, Star, ClipboardList } from "lucide-react";
...
const navItems: { to: string; label: string; icon: typeof LayoutDashboard; exact?: boolean; perm: AdminPermKey }[] = [
  ...
  { to: "/admin/anamneses", label: "Anamneses", icon: ClipboardList, perm: "anamneses" },
  { to: "/admin/users", label: "Admins", icon: ShieldCheck, perm: "users" },
  
  { to: "/admin/orders", label: "Pedidos", icon: ShoppingCart, perm: "orders" },
  { to: "/admin/estornos", label: "Estornos", icon: Undo2, perm: "orders" },
  { to: "/admin/avaliacoes", label: "Avaliações", icon: Star, perm: "orders" },
  ...
  { to: "/admin/herbalife-boletos", label: "Boletos Herbalife", icon: Truck, perm: "product_orders" },
