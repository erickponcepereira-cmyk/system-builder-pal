...
export function ProfessionalWalletTab() {
  ...
  if (!coachId) {
    return <p className="p-6 text-white/60">Carteira disponível apenas para profissionais aprovados.</p>;
  }
      ...
      <div className="rounded-2xl border border-white/5 p-5" style={{ backgroundColor: "#1A1A1A" }}>
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-white">Carteira do Profissional</h2>
          </div>
        ...
        <p className="mb-4 text-xs text-white/40">
          Mostra apenas o líquido das vendas dos seus produtos/serviços. Não inclui ganhos de coach/rede.
        </p>
...
export default ProfessionalWalletTab;
