...
export function FreebieDetailModal({ freebie, onClose, onAttend, attendLabel, attendDisabled }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex justify-center bg-background/80 backdrop-blur-sm p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center"
    >
      <div
