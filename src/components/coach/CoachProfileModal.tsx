...
export default function CoachProfileModal({ coachId, onClose }: { coachId: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-center bg-black/70 p-0 sm:p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center">
      <div
