...
export function FitmindCalendar({ compact = false, onlyHighlighted = false }: FitmindCalendarProps) {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      loadProfessionalCoachAppointments(from, to),
    ]).then(([evRes, dayRes, challengeEvents, appointmentEvents, freebieReservationEvents, professionalCoachEvents]) => {
      ...
      setEvents([...base, ...challengeEvents, ...appointmentEvents, ...freebieReservationEvents, ...professionalCoachEvents]);
...
function EventDetailModal({ event: ev, onClose, onChanged }: { event: FitmindEvent; onClose: () => void; onChanged?: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center bg-black/80 p-2 sm:p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center">
...
function CreateEventModal({ onClose, onCreated }: { onClose: () => void; onCreated: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center bg-black/80 p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center">
