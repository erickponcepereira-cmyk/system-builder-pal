...
export function PartnerDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center bg-black/80 p-0 sm:p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center">
      <div
      ...
      >
        ...
        {rejectFor && !readOnly && (
          <div className="fixed inset-0 z-[60] flex justify-center bg-black/80 p-3 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center">
