...
export function PartnerDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/80 p-0 sm:items-start sm:items-center sm:p-4 overflow-y-auto overscroll-contain modal-safe">
      <div
      ...
      >
        ...
        {rejectFor && !readOnly && (
          <div className="fixed inset-0 z-[60] flex items-start sm:items-center justify-center bg-black/80 p-3 overflow-y-auto overscroll-contain modal-safe">
