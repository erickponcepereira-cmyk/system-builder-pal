...
function CoachCoursePage() {
  ...
  const submitApplication = async () => {
    ...
    const { error } = await supabase.rpc("submit_coach_application" as never, { _motivation: motivation, _experience: experience || null, _city: city || null, _phone: phone || null } as never);
    if (error) toast.error(error.message);
