...
function AchievementReveal({ achievement, onClose }: { achievement: { code: string; title: string; icon: string | null }; onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[60] flex justify-center bg-black/85 p-6 animate-fade-in overflow-y-auto overscroll-contain modal-safe items-start sm:items-center" onClick={onClose}>
