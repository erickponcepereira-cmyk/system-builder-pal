...
function ProfessionalWalletPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-white">Carteira do Profissional</h1>
        <p className="text-xs text-white/50">
          Saldos dos profissionais como <strong>criadores de produto</strong>. Valor sai do{" "}
      ...
      <section>
        ...
        {wallets === null ? (
          ...
          <div className="rounded-lg border border-white/5 bg-white/5 p-6 text-center text-sm text-white/50">
            Nenhuma carteira de profissional com saldo.
          </div>
        ) : (
      ...
      <CreatorEntriesSection entries={entries} ownerLabel="Profissional" />
    </div>
  );
}
