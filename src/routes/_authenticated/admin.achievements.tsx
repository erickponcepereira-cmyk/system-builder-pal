...
function AdminAchievementsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex justify-center bg-black/70 p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center" onClick={() => setModalOpen(false)}>
