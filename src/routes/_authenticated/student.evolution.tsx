...
function StudentEvolution() {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 pb-6">
      ...
      {galleryOpen && (
        <div className="fixed inset-0 z-50 flex justify-center bg-black/80 p-0 sm:p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center" onClick={() => setGalleryOpen(false)}>
...
function WaterTrackerCard({ studentId }: { studentId: string }) {
  ...
  return (
    <section className="rounded-2xl bg-card p-4">
      ...
      {historyOpen && (
        <div className="fixed inset-0 z-50 flex justify-center bg-black/80 p-0 sm:p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center" onClick={() => setHistoryOpen(false)}>
