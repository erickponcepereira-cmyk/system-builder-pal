                      ...
                      <div className="flex flex-wrap justify-end gap-1">
                        ...
                        {i.status !== "paid" && i.status !== "exempted" && i.status !== "cancelled" && (
                          <>
                            ...
                            }} className="rounded bg-green-600 px-2 py-1 text-xs" title="Aplica a taxa de PIX e o imposto vigentes, em cascata">Pago PIX</button>
                            <button onClick={async () => {
                            ...
                            }} className="rounded bg-emerald-700 px-2 py-1 text-xs" title="Aplica a taxa de cartão e o imposto vigentes, em cascata">Pago Cartão</button>
                            <button onClick={async () => {
                            ...
                            }} className="rounded bg-green-900 px-2 py-1 text-xs" title="Sem taxa de gateway — apenas o imposto vigente">Pago manual</button>
                            <button onClick={async () => {
