...
function DetailModal({ row, onClose }: { row: AdminFitcoinRow; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center bg-black/70 backdrop-blur-sm sm:p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center">
