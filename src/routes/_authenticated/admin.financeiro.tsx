...
function ReconcileButton({ onDone }: { onDone: () => void }) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex justify-center bg-black/70 p-4 overflow-y-auto overscroll-contain modal-safe items-start sm:items-center" onClick={() => setOpen(false)}>
