...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://fitmindclub.com.br/" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
    links: [{ rel: "canonical", href: "https://fitmindclub.com.br/" }],
  }),
  component: Index,
});
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a
            href="https://fitmindclub.com.br/privacidade"
            style={{ color: "#FF4230", textDecoration: "underline" }}
          >
            Política de Privacidade
          </a>
          <a
            href="https://fitmindclub.com.br/termos"
            style={{ color: "#FF4230", textDecoration: "underline" }}
          >
            Termos de Uso
          </a>
