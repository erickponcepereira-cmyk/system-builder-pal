...
- **O escopo é NFS-e (serviço, ISS municipal). NF-e de produto não existe** e é outro produto: imposto estadual, layout 4.00, 27 SEFAZ, ICMS/CFOP/NCM/CST. Reaproveita certificado, assinatura, mTLS, API e painel; o núcleo fiscal é todo novo.
