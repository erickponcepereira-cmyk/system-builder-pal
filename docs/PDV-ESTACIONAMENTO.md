...
| **2. Venda e caixa** | `pdv_vendas`, `pdv_venda_itens`, `pdv_pagamentos`, **`pdv_turnos`**; rota `/pdv`, pátio, entrada, saída, recebimento em dinheiro. **Inclui a 4a** — nenhuma venda nasce sem rateio | Um dia real de operação, **fechando o caixa no fim** com a diferença explicada |
