...
Para cada caso confirmado, aplico a mesma unificação. Os cadastros de teste do Erick ficam de fora (não fazer, deixe esse ponto sem fazer, apenas me mostre quem são os duplicados com o botão de fusão caso eu queira fazer )
