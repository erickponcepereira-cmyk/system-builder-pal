...
-- ============================================================
-- FASE 1: campos da carteirinha (validade por produto)
-- ============================================================
ALTER TABLE public.products
  ADD COLUMN IF NOT EXISTS card_access_days INTEGER DEFAULT 0;

ALTER TABLE public.students
  ADD COLUMN IF NOT EXISTS card_valid_until TIMESTAMPTZ;

-- ============================================================
-- FASE 2: corrige create_store_order (kind → product_kind)
-- ============================================================
...
-- ============================================================
-- FASE 1 (cont.): estende carteirinha ao processar pagamento
-- ============================================================
CREATE OR REPLACE FUNCTION public.extend_student_card_access(
  _student_id uuid,
  _days integer
)
 RETURNS void
...
DECLARE
  ...
  v_base    TIMESTAMPTZ;
BEGIN
  IF _days IS NULL OR _days <= 0 OR _student_id IS NULL THEN RETURN; END IF;
  SELECT card_valid_until INTO v_current FROM public.students WHERE id = _student_id;
...
-- Atualiza process_paid_transaction para estender a carteirinha
-- (mantém todo o comportamento atual; só adiciona a chamada no fim)
...
BEGIN
  ...
  -- FASE 1: estende validade da carteirinha do aluno
...
-- ============================================================
-- FASE 3: carteira do sistema (admin) compartilhada
-- ============================================================
CREATE TABLE IF NOT EXISTS public.admin_system_wallet (
  id BOOLEAN PRIMARY KEY DEFAULT TRUE,
  available_balance NUMERIC(14,2) NOT NULL DEFAULT 0,
  total_earned NUMERIC(14,2) NOT NULL DEFAULT 0,
  total_withdrawn NUMERIC(14,2) NOT NULL DEFAULT 0,
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT admin_system_wallet_single CHECK (id = TRUE)
);

INSERT INTO public.admin_system_wallet (id) VALUES (TRUE) ON CONFLICT DO NOTHING;

GRANT SELECT ON public.admin_system_wallet TO authenticated;
GRANT ALL ON public.admin_system_wallet TO service_role;

ALTER TABLE public.admin_system_wallet ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS admin_system_wallet_select ON public.admin_system_wallet;
CREATE POLICY admin_system_wallet_select ON public.admin_system_wallet
  FOR SELECT TO authenticated
  USING (public.is_admin(auth.uid()));

CREATE TABLE IF NOT EXISTS public.admin_system_wallet_entries (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  transaction_id UUID REFERENCES public.transactions(id) ON DELETE CASCADE,
  slot_label TEXT,
  amount NUMERIC(14,2) NOT NULL,
  kind TEXT NOT NULL DEFAULT 'credit', -- credit | withdrawal
  notes TEXT,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

GRANT SELECT ON public.admin_system_wallet_entries TO authenticated;
GRANT ALL ON public.admin_system_wallet_entries TO service_role;

ALTER TABLE public.admin_system_wallet_entries ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS admin_system_wallet_entries_select ON public.admin_system_wallet_entries;
CREATE POLICY admin_system_wallet_entries_select ON public.admin_system_wallet_entries
  FOR SELECT TO authenticated
  USING (public.is_admin(auth.uid()));
