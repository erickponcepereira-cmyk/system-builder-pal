-- Reprocessamento de pedido: corrige três defeitos.
-- Ver 20260909190000 para o contexto — é a função que o sync de meio de
-- pagamento passou a chamar, e ela precisava ser confiável antes disso.
