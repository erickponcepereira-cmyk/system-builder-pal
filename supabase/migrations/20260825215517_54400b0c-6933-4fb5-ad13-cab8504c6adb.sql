CREATE OR REPLACE FUNCTION public.academia_renovar(p_partner_id uuid, p_credencial_id uuid, p_student_id uuid, p_plano text, p_valor numeric, p_pagamentos jsonb, p_dias integer, p_registrado_por uuid DEFAULT NULL::uuid, p_observacao text DEFAULT NULL::text, p_valido_ate date DEFAULT NULL::date)
