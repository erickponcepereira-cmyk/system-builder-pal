    ...
    LOOP
      ...
      ELSIF effective_destination IN ('professor_wallet','professor_blocked') THEN
        INSERT INTO public.professor_blocked_entries
          (transaction_id, profile_id, product_id, student_id, slot_label, amount, status, reason)
        VALUES (_transaction_id, NULL, tx.product_id, tx.student_id, slot.label, slot_amount,
                'blocked', 'Aguardando atribuição a professor');
