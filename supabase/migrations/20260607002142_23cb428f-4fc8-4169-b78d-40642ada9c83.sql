...
-- ============================================================
-- STORE: linha de rede sem upline → cai para o coach vendedor
-- ============================================================
      ...
      CASE slot.destination
        ...
        WHEN 'network_l1' THEN
          ...
          ELSIF coach_row.id IS NOT NULL THEN
            -- Sem upline na linha 1: cai para o coach vendedor
            beneficiary_profile := coach_row.profile_id;
            beneficiary_coach := coach_row.id;
          ELSE
            v_credit_admin_system := TRUE;
...
-- ============================================================
-- PARTNER: linha de rede sem upline → cai para o coach vendedor
-- ============================================================
...
BEGIN
  ...
  -- Resolve perfil do coach vendedor (fallback de linhas sem upline)
  ...
  -- Coach vendedor: comissão líquida
