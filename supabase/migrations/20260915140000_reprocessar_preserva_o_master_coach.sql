-- Reprocessar deixa de apagar o bônus de Master Coach.
--
-- `admin_reprocess_partner_order` fazia, no UPDATE do pedido:
--
--   master_coach_cross_bonus_amount = 0,
--   master_coach_cross_beneficiary_coach_id = NULL,
--
-- e `process_partner_product_order_paid` só cria a comissão de Master Coach
-- quando o beneficiário está preenchido. Resultado: todo reprocessamento
-- apagava esse bônus para sempre, sem recriar. Quem já tinha sacado ficava
-- devendo — foi o que aconteceu com a Vimark, que perdeu R$ 137,40 em dois
-- pedidos de 29/08 (R$ 68,70 cada) depois de já ter recebido o dinheiro.
--
-- O beneficiário original agora é preservado e o valor é recalculado sobre o
-- líquido novo do coach, com a mesma regra da venda: percentual do coach
-- titular do aluno, limitado a 10–70%. Não dá para redescobrir quem originou a
-- venda cruzada no reprocessamento, e é por isso que se guarda o beneficiário
-- em vez de tentar deduzi-lo.
